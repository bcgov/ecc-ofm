...
const FundingAgreementMappings = [
  ...
  // Annual Base Funding
  { back: 'ofm_envelope_hr_total_reallo', front: 'envelopeHRTotal' },
  { back: 'ofm_envelope_hr_wages_paidtimeoff_reallo', front: 'envelopeHRWagePaidTimeOff' },
  { back: 'ofm_envelope_hr_benefits_reallo', front: 'envelopeHRBenefits' },
  { back: 'ofm_envelope_hr_employerhealthtax_reallo', front: 'envelopeHREmployerHealthTax' },
  { back: 'ofm_envelope_hr_prodevhours_reallo', front: 'envelopeHRProDevHours' },
  { back: 'ofm_envelope_hr_prodevexpenses_reallo', front: 'envelopeHRProDevExpenses' },
  { back: 'ofm_envelope_programming_reallo', front: 'envelopeProgramming' },
  { back: 'ofm_envelope_administrative_reallo', front: 'envelopeAdministrative' },
  { back: 'ofm_envelope_operational_reallo', front: 'envelopeOperational' },
  { back: 'ofm_envelope_facility_reallo', front: 'envelopeFacility' },
  // Top Up Funding
