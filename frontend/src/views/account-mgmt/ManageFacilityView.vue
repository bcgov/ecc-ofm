            ...
            <v-expansion-panels v-model="panel" multiple>
              <v-expansion-panel v-for="licence in licences" :key="licence.licenceId" :value="licence.licenceId">
                <v-expansion-panel-title class="header-label">
                  ...
                  <v-col cols="auto">
                    <v-icon icon="fa:fa-regular fa-pen-to-square" class="mr-4" @click="addEditLicense(licence.licenceId)"></v-icon>
                    <v-icon icon="fa:fa-regular fa-trash-can"></v-icon>
                  </v-col>
                </v-expansion-panel-title>
                <v-expansion-panel-text>
                  <LicenceSubHeader :licence="licence" />
                  <h4 class="mb-2 mt-0 text-decoration-underline">Category Details</h4>
...
export default {
  ...
  components: { AppButton, AppBackButton, AppLabel, FacilityInfo, EditFacilityContacts, ContactInfo, LicenceHeader, LicenceSubHeader, LicenceDetails, isEmpty },
  mixins: [alertMixin],
  data() {
    return {
      facilityId: null,
  ...
  methods: {
    ...
    addEditLicense(licenceId) {
      this.$router.push({ name: 'manage-licence', params: { facilityId: this.facility.facilityId, licenceId: licenceId } });
    },
