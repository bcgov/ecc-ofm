...
export default {
  ...
  methods: {
    ...
    facilityMayContinueDraft(applicationItem) {
      const { applicationId, statusCode, applicationRenewalType } = applicationItem
      const facilityId = this.applications.find((a) => a.applicationId === applicationId).facilityId
