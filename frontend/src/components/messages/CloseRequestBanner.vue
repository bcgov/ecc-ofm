<template>
  <v-container>
    ...
    <AppDialog v-model="showConfirmDialog" title="Confirm" :is-loading="isLoading" persistent max-width="40%" @close="toggleConfirmDialog">
      <template #content>
      ...
      <template #button>
        <v-row justify="space-around">
          <v-col cols="12" md="6" class="d-flex justify-center">
            <AppButton id="dialog-go-back" :primary="false" size="large" width="200px" :loading="isLoading" @click="toggleConfirmDialog">Go back</AppButton>
          </v-col>
          <v-col cols="12" md="6" class="d-flex justify-center">
            <AppButton id="dialog-close-request" size="large" width="200px" :loading="isLoading" @click="closeAssistanceRequest">Close request</AppButton>
          </v-col>
        </v-row>
      </template>
    </AppDialog>
