  ...
  >
    ...
    <v-spacer />
      ...
      >
        ...
        >
        <!-- TODO: uncomment and resolve parsing error -->
          <!--v-list-item
            id="logout_button"
...
export default {
  data() {
    return {
      appTitle: 'Operating Funding Model', // import.meta.env.VITE_VUE_APP_TITLE
      secureAppTitle: 'Operating Funding Model', // import.meta.env.VITE_VUE_APP_TITLE,
      //routes: Routes,
      //user: null
