  ...
  <AppDialog
    ...
    <template #content>
      <div class="confirm-dialog-text">
        Thank you for your interest in joining the $10 a Day ChildCareBC Program. Based on the answers you have
        provided, your facility has not met the minimum eligibility criteria to participate at this time. For more
        information about the $10 a Day ChildCareBC Program, please visit our
    ...
    <template #button>
      <v-row justify="space-around">
        ...
        <v-col cols="12" md="6" class="d-flex justify-center">
          <AppButton id="dialog-close" size="large" width="250px" :loading="isLoading" @click="closeDialog">
            Close and Continue
          </AppButton>
        </v-col>
      </v-row>
