<template>
  <v-container fluid class="pa-2 pb-0">
    <div v-if="isEligibilityComplete">
      ...
      <div>
        <AppLabel>Have you enrolled, or are you willing to enroll, families eligible for the Affordable Child Care Benefit?</AppLabel>
      ...
      <div v-if="isOperateInPersonalResidence()">
        <AppLabel>
          Is your facility willing to operate a separate business bank account to be used exclusively for revenue and allowable expenses under the $10 a Day ChildCareBC Funding Agreement?
        </AppLabel>
