...
export const APPLICATION_ERROR_MESSAGES = Object.freeze({
  ...
  DOCUMENT_FINANCIAL_UPLOAD: 'A document upload for Financial Statement and Balance Sheet required',
  DOCUMENT_SUPPORTING_UPLOAD: 'A document upload of your Rent/Lease Agreement under Supporting Documents is required',
