...
export const FIXED_PERCENTAGE_QUESTIONS = [
  {
    ...
    calculator: (questions, responses) => {
      ...
      return { included: true, percent: Math.floor(((partTimeEnrolment + fullTimeEnrolment) / totalCapacity) * 100), totalCapacity, enrolment: partTimeEnrolment + fullTimeEnrolment }
    },
  },
  {
