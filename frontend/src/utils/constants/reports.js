...
export const FIXED_PERCENTAGE_QUESTIONS = [
  {
    ...
    calculator: (questions, responses) => {
      ...
      return { included: true, percent: parseInt(((partTimeEnrolment + fullTimeEnrolment) / totalCapacity) * 100), totalCapacity, enrolment: partTimeEnrolment + fullTimeEnrolment }
    },
  },
  {
  ...
  },
  {
    ...
    calculator: (questions, responses) => {
      ...
      if (totalCapacity <= 0) return { included: false }
      return { included: true, percent: parseInt((enrolment / totalCapacity) * 100), totalCapacity, enrolment }
    },
  },
  {
